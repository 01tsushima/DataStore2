...
val migration = object : DataMigration<Preferences> {
    ...
    val oldKey = booleanPreferencesKey(PreferenceKeys.FileDeliveryOld.FIELD_NOTIFICATION_OLD.name)
    ...
    override suspend fun migrate(currentData: Preferences): Preferences {
        ...
        mutablePrefs[PreferenceKeys.FileDeliveryNew.FIELD_NOTIFICATION_NEW] =
            when (fileDelivered) {
                false -> 0
                true -> 1
                null -> 2
